...
let lst4 = [{namae = "yoshida"; tensuu = 80; seiseki = "A"}; 
            ...
            {namae = "kaneko"; tensuu = 85; seiseki = "A"}] 
let count_A lst = List.length(List.filter (fun gakusei -> match gakusei with {namae=n; tensuu=t; seiseki=s} -> s = "A") lst)
(* テスト *) 
...
let gakusei_sum lst =
    List.fold_right (fun gakusei rest_result -> match gakusei with {namae = n; tensuu = t; seiseki = s} -> t + rest_result) lst 0
