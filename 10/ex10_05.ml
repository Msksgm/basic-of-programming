...
let rec gakusei_max lst = match lst with
    ...
    | ({namae = n; tensuu = t; seiseki = s} as gakusei) :: rest -> match gakusei_max rest with {namae = n_max; tensuu = t_max; seiseki = s_max} -> if t_max < t then gakusei else gakusei_max rest
(* テスト *) 
